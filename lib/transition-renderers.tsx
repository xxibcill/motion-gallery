...
export type ShowcaseMode = (typeof showcaseModes)[number];
export type ShowcaseModeId = ShowcaseMode["id"];
export type SpeedOption = (typeof speedOptions)[number];
export type SpeedId = SpeedOption["value"];
export type IntensityOption = (typeof intensityOptions)[number];
export type IntensityId = IntensityOption["value"];
...
export function getSpeedOption(value: SpeedId): SpeedOption {
  return speedOptions.find((option) => option.value === value) ?? speedOptions[1];
}

export function getIntensityOption(value: IntensityId): IntensityOption {
  return (
...
// Overlay renderers for each transition type
export function renderKineticPanelsOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderLiquidRevealOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  const blobColors = [
...
export function renderShutterSliceOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderSharedElementSpotlightOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderParallaxStageOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderGlitchScanOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderPaperFoldOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderMagneticCollapseOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  const points = [
...
export function renderVoidPortalOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function renderGalleryCurtainOverlay(
  prefersReducedMotion: boolean,
  motionProfile: MotionProfile
): ReactNode {
  return (
...
export function getOverlayForMode(
  ...
  switch (modeId) {
    case "kinetic-panels":
      return renderKineticPanelsOverlay(prefersReducedMotion, motionProfile);
    case "liquid-reveal":
      return renderLiquidRevealOverlay(prefersReducedMotion, motionProfile);
    case "shutter-slice":
      return renderShutterSliceOverlay(prefersReducedMotion, motionProfile);
    case "shared-element-spotlight":
      return renderSharedElementSpotlightOverlay(prefersReducedMotion, motionProfile);
    case "parallax-stage":
      return renderParallaxStageOverlay(prefersReducedMotion, motionProfile);
    case "glitch-scan":
      return renderGlitchScanOverlay(prefersReducedMotion, motionProfile);
    case "paper-fold":
      return renderPaperFoldOverlay(prefersReducedMotion, motionProfile);
    case "magnetic-collapse":
      return renderMagneticCollapseOverlay(prefersReducedMotion, motionProfile);
    case "void-portal":
      return renderVoidPortalOverlay(prefersReducedMotion, motionProfile);
    case "gallery-curtain":
      return renderGalleryCurtainOverlay(prefersReducedMotion, motionProfile);
    default:
      return null;
  }
}
